...
class ExrImage:
    ...
    def open_file(self, exr_filename : str):
        ''' open exr file and parse it
        '''
        self.m_filename = exr_filename
        self.m_exr_filedata = exr.InputFile(exr_filename)
        ...
        for key, val in header.items():
            ...
            for key, val in channels.items():
                ...
                if mask_type == 'id':
                    ...
                    idmap.m_id_label_map = self.get_channel(key).view(int).copy()
                else:
